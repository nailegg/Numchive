      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="relative h-54 overflow-hidden flex-shrink-0">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-10 pb-6 flex items-end gap-6">
            <div className="w-24 h-24 rounded flex-shrink-0 overflow-hidden shadow-2xl border border-white/15">
              {show.artwork_url ? (
                ...
                <div className="w-full h-full bg-nc-surface2 flex items-center justify-center text-nc-text-muted">
                  <HugeiconsIcon icon={TheaterIcon} size={30} color="currentColor" />
                </div>
              )}
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-mono text-[11px] tracking-[0.2em] text-nc-accent mb-1">
        ...
        <div className="flex flex-col flex-1 min-h-0 px-10 py-4">
          <div className="flex items-center justify-between pb-3 border-b border-white/15 mb-1 flex-shrink-0">
            <span className="font-mono text-[11px] tracking-[0.18em] text-nc-text-muted uppercase">
              트랙 목록
            </span>
